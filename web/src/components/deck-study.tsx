...
/**
 * Owns the loaded-deck experience: the study setup screen, and the active
 * study session once a target is chosen.
 */
export function DeckStudy() {
  ...
  return <StudySetup onStart={(folder) => setTarget({ folder })} />;
}
