...
/**
 * The in-app organize screen: create, rename, duplicate, and delete folders,
 * add and remove cards, browse cards by folder, move cards between folders, and
 * tag folders. A card's Japanese and English text is read-only once created.
 */
export function DeckOrganize({ onBack }: DeckOrganizeProps) {
  const { cards, folders, tags, folderTags, moveCard, removeCard } =
    useFlashcards();
